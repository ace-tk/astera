// Generated from the `world-countries` dataset (name, ISO2, calling code) — kept
// as a static file so the app doesn't ship the full package at runtime. Flag
// emoji is derived from the ISO2 code (regional indicator symbols), not hand-typed.
export const CALLING_CODES = [
  { name: 'Afghanistan', iso2: 'AF', dial: '+93' },
  { name: 'Åland Islands', iso2: 'AX', dial: '+35818' },
  ...
  { name: 'Saint Helena, Ascension and Tristan da Cunha', iso2: 'SH', dial: '+2' },
  ...
  { name: 'South Georgia', iso2: 'GS', dial: '+500' },
  ...
  { name: 'Svalbard and Jan Mayen', iso2: 'SJ', dial: '+4779' },
  ...
  { name: 'United States Minor Outlying Islands', iso2: 'UM', dial: '+268' },
  ...
  { name: 'Western Sahara', iso2: 'EH', dial: '+2' },
...
/** Formatted option label for the searchable phone-code picker, e.g. "\ud83c\uddee\ud83c\uddf3 India (+91)". */
export const callingCodeLabel = (c) => `${flagOf(c.iso2)} ${c.name} (${c.dial})`

/** Parse the dial code back out of a formatted label. */
export const dialFromLabel = (label) => {
