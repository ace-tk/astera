 ...
 */
export default function PricingCalculator({ tiers, durationMin = 1, durationMax = 8, durationDefault = 2, disclaimer, cta, color = 'golden' }) {
      ...
      <div className="rounded-[2rem] border border-ink/8 bg-card p-8 shadow-soft sm:p-10">
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
          ...
          <div className="flex flex-col justify-between rounded-[1.6rem] bg-paper p-7">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">Estimate</p>
              <div className="mt-2 flex items-end gap-2">
                <span className="font-display text-5xl font-semibold tracking-tight">{estimate}€</span>
                <span className="mb-1.5 text-sm text-muted">HT</span>
              </div>
