...
import { TRAINING_NAV, FORMATION_CSE as C } from '@/constants/training'

export default function FormationCse() {
  usePageMeta({ title: `${stripEmphasis(C.hero.title)} (Formation CSE)`, description: C.hero.lead })
